...
\begin{align*}
	...
	&A \curlyvee A_1,A_2 & \text{if } \stack{A}, \stack{A_1}, \stack{A_2} \;\text{and}\; A \equiv A_1 \equiv A_2
\end{align*}
...
\begin{lemma}
Let $V,H,R,F \vdash^{\mathsf{copy}} v,H',F'$. Then there exists an $F''$ s.t.
$V,H,R,F \vdash^{\mathsf{free}} v,H',F''$ and $|F''| \ge |F'|$.
\end{lemma}
