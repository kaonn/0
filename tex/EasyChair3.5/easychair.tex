...
%
Types are formally defined in Figure~\ref{fig:types}. Like in all
...
To simplify the presentation, the expressions of our language are in \emph{let normal form} (also called \emph{A normal form}).
...
\yue{add an short intro sentence; cite Morrisett95 Spoonhower:2008:SPP:1411204.1411240 and DBLP:journals/entcs/Minamide99}
