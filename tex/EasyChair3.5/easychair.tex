...
predecessors~\cite{Spoonhower:2008:SPP:1411204.1411240,DBL     Note: Visa Forms MUST BE TYPED before print out; Then must Sign

P:journals/entcs/Minamide99}
...
convenient to just view $R$ as a set. 
...
\begin{attempt}
	...
	$\mathcal{C}_2 \vdash^{\copySem} e \Downarrow v,H',F'$, and $H' \vDash v \mapsto a : A$, 
...
For the second part of the proof, we show $\fogc$ is sound w.r.t. \copySem{}. First,
we characterize semantically linear contexts: 
...
\infer[\text{L:ShareCopy}]{
  ...
  \shareabt{l}{l1}{l2}{\uletabt{l1'}{append(l1,[])}{\uletabt{l2'}{append(l2,[])}{\pairexcst{l1'}{l2'}}}}
  : \prodtycst{L^r(A)}{L^s(A)}
}{
  L^{r+s+1}(A) \curlyvee^1 L^r(A), L^s(A)&
  \infer[\text{L:Let}]{
  \Sigma; l1 : L^r(A), l2 : L^s(A) \sststile{q}{q}
  \uletabt{l1'}{append(l1,[])}{\uletabt{l2'}{append(l2,[])}{\pairexcst{l1'}{l2'}}}
  : \prodtycst{L^r(A)}{L^s(A)}
}{
  \infer[\text{L:Fun}]
  {
    \Sigma; l1 : L^r(A) \sststile{q}{q} append(l1,[]) : L^r(A)
  }{
    \pairexcst{l1}{[]} : \prodtycst{L^r(A)}{L^r(A)}&
    \Sigma(append) = \prodtycst{L^r(A)}{L^r(A)} \xrightarrow{q/q} \L^r(A)
    }
  &...
}
}\\
\text{Derivation of ...}\\
  ...
  \infer[\text{L:Let}]{
  \Sigma;l2 : L^s(A),l1' : L^r(A) \sststile{q}{q} \uletabt{l2'}{append(l2,[])}{\pairexcst{l1'}{l2'}}
  : \prodtycst{L^r(A)}{L^s(A)}
}{
   \infer[\text{L:Fun}]
   {
     \Sigma;l2 : L^s(A) \sststile{q}{q} append(l2,[]) : L^s(A)
   }{
    \pairexcst{l2}{[]} : \prodtycst{L^s(A)}{L^s(A)}&
    \Sigma(append) = \prodtycst{L^s(A)}{L^s(A)} \xrightarrow{q/q} \L^s(A)
  }&
  \infer[\text{L:Pair}]{
