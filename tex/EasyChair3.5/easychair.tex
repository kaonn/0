...
We define the language by an operational cost semantics \gcSem 
...
\copySem which is exactly the same as \gcSem, except that variables are used in 
a linear way. We prove the soundness of \copySem with respect to $\fogc$, then prove that
\copySem is an over-approximation of \gcSem in the sense that any program that can be 
successfully completed when interpreted with \copySem can also be completed with \gcSem 
