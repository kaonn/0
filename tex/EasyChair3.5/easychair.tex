...
garbage collection. The only exceptions we are aware of are \jan{gc papers}
However, ... \jan{what's bad?}
%
In contrast, \jan{ours is better}

\yue{unify type setting of code} We model the (highwater mark) memory
...
proofs and ideas carry over the more complex case of RaML.
%
...
In \ref{Hoffmann:2015:ASC:2769448.2769449}, the authors have successfully employed this 
