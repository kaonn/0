\newcommand{\typkdabt}{\kw{Type}}
\newcommand{\typkdcst}{\kw{T}}
\newcommand{\prodkdabt}[2]{\OpABT{\kw{Prod}}{#1;#2}}
\newcommand{\prodkdcst}[2]{{#1}\mathbin{\mathbf{\times}}{#2}}
\newcommand{\arrkdabt}[2]{\OpABT{\kw{Arr}}{#1;#2}}
...
\newcommand{\callabt}[1]{\OpABTn{\kw{all}}{#1}}
\newcommand{\callcst}[1]{\forall_{#1}}
\newcommand{\csomeabt}[1]{\OpABTn{\kw{some}}{#1}}
\newcommand{\csomecst}[1]{\exists_{#1}}
\newcommand{\clamabt}[3]{\OpABTp{\kw{lam}}{#1}{\AbsABT{#2}{#3}}}
\newcommand{\clamcst}[3]{\mathop{\lambda}\cdparens{\TightIsOfKd{#2}{#1}}\,{#3}}
\newcommand{\culamabt}[2]{\OpABT{\kw{lam}}{\AbsABT{#1}{#2}}}
...
\newcommand{\allkcst}[3]{\mathop{\forall}\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}
\newcommand{\somekabt}[3]{\OpABTp{\kw{some}}{#1}{\AbsABT{#2}{#3}}}
\newcommand{\somekcst}[3]{\mathop{\exists}\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}
...
\newcommand{\allktycstalt}[3]{\cappcst{\forall}{\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}}
...
\newcommand{\somektyabtalt}[3]{\OpABTp{\kw{some}}{#1}{\AbsABT{#2}{#3}}}
\newcommand{\somektycstalt}[3]{\cappcst{\exists}{\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}}
...
\newcommand{\tlamkcst}[3]{\Lambda\cdparens{\TightIsOfKd{#2}{#1}}\,{#3}}
...
\newcommand{\opnkabt}[7]{\OpABTpp{\kw{open}}{#1}{\AbsABT{#2}{#3}}{#5;\AbsABT{#2,#6}{#7}}}
\newcommand{\opnkcst}[7]{\kwop{open}{#5}\kwop{as}\TightIsOfKd{#2}{#1}\kwop{with}\TightIsOf{#6}{#3}\kwop{in}{#7}}
...
\newcommand{\pikdcst}[3]{\mathop{\Pi}\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}
\newcommand{\sigkdabt}[3]{\OpABT{\Sigma}{#1;\AbsABT{#2}{#3}}}
\newcommand{\sigkdcst}[3]{\mathop{\Sigma}\AbsABT{\TightIsOfKd{#2}{#1}}{#3}}
