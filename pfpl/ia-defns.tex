\newcommand{\LangMA}{\textbsf{MA}}

\newcommand{\LangRMA}{\textbsf{RMA}}
\newcommand{\LangRPCF}{\textbsf{RPCF}}

\newcommand{\MState}[2]{{#2}\mathrel{\parallel}{#1}}
\newcommand{\RState}[3]{\mathop{\nu}{#2}\,\braces{\,{#3}\mathrel{\parallel}{#1}\,}}

\newcommand{\commtyabt}{\kw{comm}}
\newcommand{\commtycst}{\kw{comm}}
...
\newcommand{\ifzcmdabt}[3]{\OpABT{\kw{if}}{{#1};{#2};{#3}}}
\newcommand{\ifzcmdcst}[3]{\kwop{if}\cdparens{#1}\,{#2}\kwbin{else}{#3}}
...
\newcommand{\refsetcst}[2]{{#1}\kwop{{*}{=}}{#2}}
\newcommand{\refsetplus}[2]{{#1}\mathop{\cd{+=}}{#2}}
